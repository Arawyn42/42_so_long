...
/*   Updated: 2023/11/30 19:25:19 by drenassi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_left(t_data *data)
{
	...
	if (data->map.map[data->pos.y][data->pos.x - 1] == 'C' && data->inp.left)
		ft_left_item_anim(data);
	if (data->map.map[data->pos.y][data->pos.x - 1] == 'D' && data->inp.left)
		ft_left_anim(data);
	if (data->clock == 18000)
		data->inp.left = 0;
}
